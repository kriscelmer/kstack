...
6. Export the branch contract with `$KSTACK_STATE export-contract`.
7. Tell the user the branch is now ready for a Draft PR and the PR body can be generated with `$KSTACK_STATE export-pr`.
