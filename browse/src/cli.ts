/**
 * kstack browse CLI — thin wrapper that talks to the persistent server
 *
 * Flow:
 *   1. Read .kstack/browse.json for port + token
...
function cleanupLegacyState(): void {
  // No legacy state on Windows — /tmp and `ps` don't exist, and the older runtime
