...
describe('gen-skill-docs', () => {
  test('generates Codex-native skills and removes stale gstack skill dirs', () => {
    ...
    expect(fs.existsSync(path.join(ROOT, '.agents', 'skills', 'discover', 'SKILL.md'))).toBe(true);
    expect(fs.existsSync(path.join(ROOT, '.agents', 'skills', 'sprint-freeze', 'SKILL.md'))).toBe(true);
    expect(fs.existsSync(path.join(ROOT, '.agents', 'skills', 'ingest-learning', 'SKILL.md'))).toBe(true);
    ...
    expect(rootSkill).toContain('/discover');
    expect(rootSkill).toContain('/sprint-freeze');
    expect(rootSkill).toContain('/ingest-learning');
